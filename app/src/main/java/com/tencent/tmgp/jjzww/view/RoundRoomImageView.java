...
/**
 * Created by yincong on 2018/1/8 10:09
 * 修改人：
 * 修改时间：
 * 类描述：房间列表自定义imageview
 */
public class RoundRoomImageView extends ImageView {
    ...
    public RoundRoomImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public RoundRoomImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RoundRoomImageView(Context context) {
        super(context);
        init(context, null);
    }
